            ...
            <div className='sky-top'>
                <Modal
                    ...
                    <div className='popup-frame'>
                        <div className='close-popup' onClick={() => handleClosePopup()}>
                            <img src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.popupComingSoon.closePopup} alt='' />
                        </div>
                        <div className='popup-title'>
                            <div className='popup-title__box'>
                                <img src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.popupComingSoon.frameComingSoon} alt='' />
                ...
                <div className='gameplay-selection'>
                    <div className='gameplay__selection-img'>
                        <a href='#drop'>
                            <img className='shadow-stone shadow-stone-1' src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.skyTop.shadowStone} alt="" />
                            <img src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.skyTop.drop} alt="" />
                        </a>
                    </div>
                    <div className='gameplay__selection-img'>
                        <a href='#nest'>
                            <img className='shadow-stone shadow-stone-2' src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.skyTop.shadowStone} alt="" />
                            <img src={_.isEmpty(urlApi) ? '' : urlApi.imageGamePlay.skyTop.nest} alt="" />
                        </a>
                    </div>
                    <div className='rune'>
                        <Link to='/'>
                ...
                <div className='gameplay-logo'>
                    <img className="gameplay__logo-img" src={_.isEmpty(urlApi) ? '' : urlApi.image.eluLogo} alt="" />
                </div>
            </div>
        </UrlRescusive>
    )
