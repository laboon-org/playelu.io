...
export default function Header(props) {
    ...
    return (
        <div className='navbar-header'>
            <div className='menu'>
                <a className='playelu__menu-element' href={_.isEmpty(urlApi) ? '' : urlApi.docs.roadmap} target='_blank'>
                    <h4>Roadmap</h4>
                </a>
                <a className='playelu__menu-element' href={_.isEmpty(urlApi) ? '' : urlApi.docs.tokenomic} target='_blank'>
                    <h4>Tokenomic</h4>
                </a>
                <Link to='/gameplay' className='playelu__menu-element'>
                    <h4>gameplay</h4>
                </Link>
                <a className='playelu__menu-element' href={_.isEmpty(urlApi) ? '' : urlApi.docs.litepaper} target='_blank'>
                    <h4>Litepaper</h4>
                </a>
            </div>
